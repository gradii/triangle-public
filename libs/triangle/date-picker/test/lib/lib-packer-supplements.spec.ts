...
import { CalendarHeaderComponent } from '../../lib/calendar/calendar-header.component';
import { TodayButtonComponent } from '../../lib/calendar/today-button.component';
import { DateTableComponent } from '../../lib/date/date-table.component';
import { LibPackerModule } from '../../lib/lib-packer.module';
import { MonthTableComponent } from '../../lib/month/month-table.component';
import { DateRangePopupComponent } from '../../lib/popups/date-range-popup.component';
import { YearPanelComponent } from '../../lib/year/year-panel.component';
import { AbstractPickerComponent } from '../../src/abstract-picker.component';
...
describe('coverage supplements', () => {
  ...
  beforeEach(inject([I18nService], (service) => {
    i18n = service;
  }));
  ...
  describe('AbstractPicker', () => {
    ...
    it('should cover untouched branches', () => {
      // onOpenChange
      const emit = spyOn(componentInstance.onOpen, 'emit');
      componentInstance.onOpenChange(true);
      expect(emit).toHaveBeenCalled();

      // setDisabledState
      componentInstance.setDisabledState(true);
      expect(componentInstance.disabled).toBeTruthy();
    });
