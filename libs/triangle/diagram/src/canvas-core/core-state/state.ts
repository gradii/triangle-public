...
import { intersection } from '@gradii/nanofn';
...
export abstract class State<E extends CanvasEngine = CanvasEngine> {
  ...
  private handler1: (...args: any[]) => any;
  private handler2: (...args: any[]) => any;
  ...
  transitionWithEvent(state: State, event: ActionEvent<UIEvent>) {
