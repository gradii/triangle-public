 ...
 */
export const TRI_DRAG_PLACEHOLDER = new InjectionToken<TriDragPlaceholder>('TriDragPlaceholder');
 ...
 */
@Directive({
  selector : 'ng-template[triDragPlaceholder]',
  providers: [{provide: TRI_DRAG_PLACEHOLDER, useExisting: TriDragPlaceholder}],
})
export class TriDragPlaceholder<T = any> {
