...
export class TriDropFlexContainer<T = any> extends TriDropContainer implements OnDestroy {
   ...
   * or their unique IDs.
   */
  @Input('triDropFlexContainerConnectedTo')
  connectedTo: (TriDropContainer | string)[] | TriDropContainer | string = [];

  /** Arbitrary data to attach to this container. */
  @Input('triDropFlexContainerData')
  data: T;

  /** Direction in which the list is oriented. */
  @Input('triDropFlexContainerOrientation')
  orientation: DropContainerOrientation;

  /** Locks the position of the draggable elements inside the container along the specified axis. */
  @Input('triDropFlexContainerLockAxis')
  lockAxis: DragAxis;

  /** Whether sorting within this drop list is disabled. */
  @Input('triDropFlexContainerSortingDisabled')
   ...
   */
  @Input('triDropFlexContainerEnterPredicate')
  enterPredicate: (drag: TriDrag, drop: TriDropFlexContainer) => boolean = () => true;

  /** Functions that is used to determine whether an item can be sorted into a particular index. */
  @Input('triDropFlexContainerSortPredicate')
  sortPredicate: (index: number, drag: TriDrag, drop: TriDropFlexContainer) => boolean = () => true;

  /** Whether to auto-scroll the view when the user moves their pointer close to the edges. */
  @Input('triDropFlexContainerAutoScrollDisabled')
  autoScrollDisabled: boolean;

  /** Number of pixels to scroll for each frame when auto-scrolling an element. */
  @Input('triDropFlexContainerAutoScrollStep')
  autoScrollStep: number;

  /** Emits when the user drops an item inside the container. */
  @Output('triDropFlexContainerDropped')
  readonly dropped: EventEmitter<TriDragDrop<T, any>> = new EventEmitter<TriDragDrop<T, any>>();

  /**
   * Emits when the user has moved a new drag item into this container.
   */
  @Output('triDropFlexContainerEntered')
   ...
   */
  @Output('triDropFlexContainerExited')
  ...
  constructor(
    ...
    protected _group?: TriDropContainerGroup<TriDropFlexContainer>,
    ...
    this._dropContainerRef      = dragDrop.createDropFlexContainerRef(element);
    ...
    this._dropContainerRef.enterPredicate = (drag: DragRef<TriDrag>,
                                             drop: DndContainerRef<TriDropFlexContainer>) => {
      return this.enterPredicate(drag.data, drop.data);
    };

    this._dropContainerRef.sortPredicate =
      (index: number, drag: DragRef<TriDrag>, drop: DndContainerRef<TriDropFlexContainer>) => {
