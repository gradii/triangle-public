 ...
 */
export const TRI_RESIZE_PREVIEW = new InjectionToken<TriResizePreview>('TriResizePreview');
 ...
 */
@Directive({
  selector : 'ng-template[triResizePreview]',
  providers: [{provide: TRI_RESIZE_PREVIEW, useExisting: TriResizePreview}],
})
export class TriResizePreview<T = any> {
