...
import {TriDrawer, TriSidenavModule, TriDrawerContainer} from './index';
...
describe('TriDrawer', () => {
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      imports: [TriSidenavModule, A11yModule, PlatformModule, NoopAnimationsModule, CommonModule],
      declarations: [
        BasicTestApp,
  ...
  describe('methods', () => {
    ...
    it('should resolve the open method promise with the new state of the drawer', fakeAsync(() => {
      const fixture = TestBed.createComponent(BasicTestApp);
      fixture.detectChanges();
      const drawer: TriDrawer =
          fixture.debugElement.query(By.directive(TriDrawer))!.componentInstance;
    ...
    it('should resolve the close method promise with the new state of the drawer', fakeAsync(() => {
      const fixture = TestBed.createComponent(BasicTestApp);
      fixture.detectChanges();
      const drawer = fixture.debugElement.query(By.directive(TriDrawer))!;
      const drawerInstance: TriDrawer = drawer.componentInstance;
    ...
    it('should not close by clicking on the backdrop when disableClose is set', fakeAsync(() => {
      const fixture = TestBed.createComponent(BasicTestApp);
      const testComponent = fixture.debugElement.componentInstance;
      const drawer = fixture.debugElement.query(By.directive(TriDrawer))!.componentInstance;
    ...
    it('should not restore focus on close if focus is outside drawer', fakeAsync(() => {
      const fixture = TestBed.createComponent(BasicTestApp);
      const drawer: TriDrawer = fixture.debugElement
          .query(By.directive(TriDrawer))!.componentInstance;
      fixture.detectChanges();
  ...
  describe('attributes', () => {
    it('should correctly parse opened="false"', () => {
      ...
      expect((drawer as TriDrawer).opened).toBe(false);
    });
    ...
    it('should correctly parse opened="true"', () => {
      ...
      expect((drawer as TriDrawer).opened).toBe(true);
    });
      ...
      fakeAsync(() => {
        TestBed
          ...
          .configureTestingModule({
            imports: [TriSidenavModule, BrowserAnimationsModule],
  ...
  describe('focus trapping behavior', () => {
    ...
    beforeEach(() => {
      ...
      drawer = fixture.debugElement.query(By.directive(TriDrawer))!.componentInstance;
    ...
    it('should focus the drawer if there are no focusable elements', fakeAsync(() => {
      ...
      const drawerEl = nonFocusableFixture.debugElement.query(By.directive(TriDrawer))!;
...
describe('TriDrawerContainer', () => {
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      imports: [TriSidenavModule, A11yModule, PlatformModule, NoopAnimationsModule],
      declarations: [
  ...
  it('should be able to open and close all drawers', fakeAsync(() => {
    ...
    const drawers = fixture.debugElement.queryAll(By.directive(TriDrawer));
...
/** Test component that contains an TriDrawerContainer but no TriDrawer. */
@Component({template: `<mat-drawer-container></mat-drawer-container>`})
class DrawerContainerNoDrawerTestApp { }

/** Test component that contains an TriDrawerContainer and 2 TriDrawer in the same position. */
@Component({
  template: `
...
class DrawerContainerTwoDrawerTestApp {
  @ViewChild(TriDrawerContainer) drawerContainer: TriDrawerContainer;
}

/** Test component that contains an TriDrawerContainer and one TriDrawer. */
@Component({
  template: `
...
class BasicTestApp {
  ...
  @ViewChild('drawer') drawer: TriDrawer;
...
class DrawerDelayed {
  @ViewChild(TriDrawer) drawer: TriDrawer;
  showDrawer = false;
}
...
class IndirectDescendantDrawer {
  @ViewChild('container') container: TriDrawerContainer;
  @ViewChild('drawer') drawer: TriDrawer;
}
...
class NestedDrawerContainers {
  @ViewChild('outerContainer') outerContainer: TriDrawerContainer;
  @ViewChild('outerDrawer') outerDrawer: TriDrawer;
  @ViewChild('innerContainer') innerContainer: TriDrawerContainer;
  @ViewChild('innerDrawer') innerDrawer: TriDrawer;
}
