...
import {TriSidenav, TriSidenavModule, TriSidenavContainer} from './index';
...
describe('TriSidenav', () => {
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      imports: [TriSidenavModule, NoopAnimationsModule, CommonModule],
  ...
  it('should be fixed position when in fixed mode', () => {
    ...
    const sidenavEl = fixture.debugElement.query(By.directive(TriSidenav))!.nativeElement;
...
class IndirectDescendantSidenav {
  @ViewChild('container') container: TriSidenavContainer;
...
class NestedSidenavContainers {
  @ViewChild('outerContainer') outerContainer: TriSidenavContainer;
  @ViewChild('outerSidenav') outerSidenav: TriSidenav;
  @ViewChild('innerContainer') innerContainer: TriSidenavContainer;
  @ViewChild('innerSidenav') innerSidenav: TriSidenav;
}
