...
@Component({
  selector: 'tri-fullscreen',
  templateUrl: './fullscreen.component.html',
  styleUrls: ['../style/fullscreen.component.scss'],
...
export class FullscreenComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  @Input()
  mode: FullscreenMode = DEFAULT_MODE;
  ...
  @Output() 
  fullscreenLaunch: EventEmitter<any> = new EventEmitter<any>();
