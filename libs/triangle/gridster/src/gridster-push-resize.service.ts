...
export class GridsterPushResize {
  ...
  private tryPattern: {
    fromEast:
      (gridsterItemCollide: GridsterItemComponentInterface,
       gridsterItem: GridsterItemComponentInterface, direction: string) => boolean,
    fromWest:
      (gridsterItemCollide: GridsterItemComponentInterface,
       gridsterItem: GridsterItemComponentInterface, direction: string) => boolean,
    fromNorth:
  ...
  private push(gridsterItem: GridsterItemComponentInterface, direction: string): boolean {
    const gridsterItemCollision: GridsterItemComponentInterface | boolean = this.gridster.checkCollision(
      gridsterItem.$item);
