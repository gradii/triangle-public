...
export class GridsterPush {
  ...
  private tryPattern: {
    fromEast: ((gridsterItemCollide: GridsterItemComponentInterface,
                gridsterItem: GridsterItemComponentInterface) => boolean)[],
    fromWest: ((gridsterItemCollide: GridsterItemComponentInterface,
                gridsterItem: GridsterItemComponentInterface) => boolean)[],
    fromNorth: ((gridsterItemCollide: GridsterItemComponentInterface,
                 gridsterItem: GridsterItemComponentInterface) => boolean)[],
    fromSouth: ((gridsterItemCollide: GridsterItemComponentInterface,
                 gridsterItem: GridsterItemComponentInterface) => boolean)[]
  };
  private iteration = 0;
  ...
  private push(gridsterItem: GridsterItemComponentInterface, direction: string): boolean {
    ...
    const conflicts: GridsterItemComponentInterface[] = this.gridster.findItemsWithItem(
      gridsterItem.$item);
  ...
  private trySouth(gridsterItemCollide: GridsterItemComponentInterface,
                   gridsterItem: GridsterItemComponentInterface): boolean {
  ...
  private tryNorth(gridsterItemCollide: GridsterItemComponentInterface,
                   gridsterItem: GridsterItemComponentInterface): boolean {
  ...
  private tryEast(gridsterItemCollide: GridsterItemComponentInterface,
                  gridsterItem: GridsterItemComponentInterface): boolean {
  ...
  private tryWest(gridsterItemCollide: GridsterItemComponentInterface,
                  gridsterItem: GridsterItemComponentInterface): boolean {
