...
import { GridsterPushResize } from './gridster-push-resize.service';
import { GridsterResizeEventType } from './gridster-resize-event-type.interface';

import { cancelScroll, scroll } from './gridster-scroll.service';
...
export class GridsterResizable {
  ...
  directionFunction: (e: Required<{ clientX: number, clientY: number }>) => void;
  ...
  dragStart(e: MouseEvent): void {
    ...
    this.minHeight           = this.gridster.positionYToPixels(
      this.gridsterItem.$item.minItemRows || this.gridster.$options.minItemRows)
      - this.margin;
    this.minWidth            = this.gridster.positionXToPixels(
  ...
  dragMove(e: MouseEvent): void {
    ...
    scroll(this.gridster, this.left, this.top, this.width, this.height, e, this.lastMouse,
      this.directionFunction.bind(this), true,
