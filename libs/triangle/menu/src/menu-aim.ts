...
export const MENU_AIM = new InjectionToken<MenuAim>('tri-menu-aim');
...
/**
 * TriTargetMenuAim is a provider for the TargetMenuAim service. It should be added to an
 * element with either the `triMenu` or `triMenuBar` directive and child menu items.
 */
@Directive({
  selector : '[triTargetMenuAim]',
  exportAs : 'triTargetMenuAim',
  providers: [{provide: MENU_AIM, useClass: TargetMenuAim}],
})
export class TriTargetMenuAim {
}
