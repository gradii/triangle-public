...
describe("MatSelect", () => {
  ...
  describe("core", () => {
    ...
    describe("accessibility", () => {
      describe("for select", () => {
        ...
        it("should point the aria-controls attribute to the listbox", fakeAsync(() => {
          ...
          expect(ariaControls).toBe(
            document.querySelector(".mat-select-panel")!.id
          );
        }));
        ...
        it("should be able to add an extra aria-labelledby on top of the default", fakeAsync(() => {
          ...
          const valueId =
            fixture.nativeElement.querySelector(".mat-select-value").id;

          expect(select.getAttribute("aria-labelledby")).toBe(
            `${labelId} ${valueId} myLabelId`
          );
        }));
        ...
        it("should set `aria-labelledby` to the value ID if there is no form field", () => {
          ...
          const valueId =
            labelFixture.nativeElement.querySelector(".mat-select-value").id;
        ...
        it(
          ...
          fakeAsync(() => {
            ...
            expect(options[0].selected)
              ...
              .toBe(false);
            expect(formControl.value)
              .withContext("Expected value to be reset.")
              .toBeFalsy();
        ...
        it("should not open the select when pressing space while typing", fakeAsync(() => {
          ...
          fixture.componentInstance.typeaheadDebounceInterval =
            DEFAULT_TYPEAHEAD_DEBOUNCE_INTERVAL;
          fixture.detectChanges();
        ...
        it("should not prevent the default actions on selection keys when pressing a modifier", fakeAsync(() => {
          [ENTER, SPACE].forEach((key) => {
            const event = createKeyboardEvent("keydown", key, undefined, {
              shift: true,
            });
      ...
      describe("for options", () => {
        ...
        it("should set aria-selected on each option for single select", fakeAsync(() => {
          expect(
            ...
            .withContext(
              "Expected all unselected single-select options not to have " +
                "aria-selected set."
            )
            .toBe(true);
        ...
        it("should set aria-selected on each option for multi-select", fakeAsync(() => {
          ...
          expect(
            ...
            .withContext(
              "Expected all unselected multi-select options to have " +
                'aria-selected="false".'
            )
            .toBe(true);
          ...
          expect(options[1].getAttribute("aria-selected"))
            .withContext(
              "Expected selected multi-select option to have " +
                'aria-selected="true".'
            )
            .toEqual("true");
          options.splice(1, 1);
        ...
        it("should remove the active state from options that have been deselected while closed", fakeAsync(() => {
          let activeOptions = options.filter((option) =>
            option.classList.contains("mat-active")
          );
          ...
          expect(activeOptions)
            .withContext(
              "Expected only selected option to be marked as active after " +
                "it is clicked."
            )
            .toEqual([options[1]]);

          fixture.componentInstance.control.setValue(
            fixture.componentInstance.foods[7].value
          );
          fixture.detectChanges();
          fixture.componentInstance.select.close();
          fixture.detectChanges();
    ...
    describe("overlay panel", () => {
      ...
      it("should update the width of the panel on resize", fakeAsync(() => {
        ...
        expect(parseInt(pane.style.minWidth || "0")).toBeGreaterThan(
          initialWidth
        );
      }));
      ...
      it("should close when tabbing out from inside the panel", fakeAsync(() => {
        ...
        const panel =
          overlayContainerElement.querySelector(".mat-select-panel")!;
      ...
      it("should update disableRipple properly on each option", fakeAsync(() => {
        ...
        expect(options.every((option) => option.disableRipple === false))
          .withContext(
            "Expected all options to have disableRipple set to false initially."
          )
          .toBeTruthy();
        ...
        expect(options.every((option) => option.disableRipple === true))
          .withContext(
            "Expected all options to have disableRipple set to true."
          )
          .toBeTruthy();
      }));
      ...
      it("should be able to render options inside groups with an ng-container", fakeAsync(() => {
        ...
        expect(
          document.querySelectorAll(".cdk-overlay-container mat-option").length
        )
    ...
    describe("selection logic", () => {
      ...
      it("should not select options inside a disabled group", fakeAsync(() => {
        ...
        const disabledGroup =
          overlayContainerElement.querySelectorAll("mat-optgroup")[1];
  ...
  describe("when initialized without options", () => {
    beforeEach(waitForAsync(() =>
      configureMatSelectTestingModule([SelectInitWithoutOptions])));
  ...
  describe("with a selectionChange event handler", () => {
    beforeEach(waitForAsync(() =>
      configureMatSelectTestingModule([SelectWithChangeEvent])));
  ...
  describe("with ngIf", () => {
    beforeEach(waitForAsync(() =>
      configureMatSelectTestingModule([NgIfSelect])));
  ...
  describe("with multiple mat-select elements in one view", () => {
    beforeEach(waitForAsync(() =>
      configureMatSelectTestingModule([ManySelects])));
  ...
  describe("with floatLabel", () => {
    beforeEach(waitForAsync(() =>
      configureMatSelectTestingModule([FloatLabelSelect])));
  ...
  describe("with tabindex", () => {
    beforeEach(waitForAsync(() =>
      configureMatSelectTestingModule([SelectWithPlainTabindex])));
  ...
  describe("when initially hidden", () => {
    beforeEach(waitForAsync(() =>
      configureMatSelectTestingModule([BasicSelectInitiallyHidden])));
  ...
  describe("with no placeholder", () => {
    beforeEach(waitForAsync(() =>
      configureMatSelectTestingModule([BasicSelectNoPlaceholder])));
  ...
  describe("with theming", () => {
    beforeEach(waitForAsync(() =>
      configureMatSelectTestingModule([BasicSelectWithTheming])));
  ...
  describe("when invalid inside a form", () => {
    beforeEach(waitForAsync(() =>
      configureMatSelectTestingModule([InvalidSelectInForm])));
  ...
  describe("with ngModel using compareWith", () => {
    beforeEach(waitForAsync(() =>
      configureMatSelectTestingModule([NgModelCompareWithSelect])));
    ...
    describe("comparing by reference", () => {
      ...
      it("should throw an error when using a non-function comparator", fakeAsync(() => {
        ...
        expect(() => {
          ...
          wrappedErrorMessage(getMatSelectNonFunctionValueError())
        );
      }));
    });
  });
  ...
  describe(`when the select's value is accessed on initialization`, () => {
    beforeEach(waitForAsync(() =>
      configureMatSelectTestingModule([SelectEarlyAccessSibling])));
  ...
  describe("with ngIf and mat-label", () => {
    beforeEach(waitForAsync(() =>
      configureMatSelectTestingModule([SelectWithNgIfAndLabel])));
  ...
  describe("inside of a form group", () => {
    beforeEach(waitForAsync(() =>
      configureMatSelectTestingModule([SelectInsideFormGroup])));
    ...
    it("should set an asterisk after the label if the FormControl is required", fakeAsync(() => {
      expect(
        fixture.nativeElement.querySelector(".mat-form-field-required-marker")
      ).toBeTruthy();
    }));
  });
  ...
  describe("with custom error behavior", () => {
    beforeEach(waitForAsync(() =>
      configureMatSelectTestingModule([CustomErrorBehaviorSelect])));
  ...
  describe("with custom value accessor", () => {
    ...
    it("should support use inside a custom value accessor", fakeAsync(() => {
      ...
      expect(fixture.componentInstance.customAccessor.select.ngControl)
        ...
        .toBeFalsy();
      expect(
        fixture.componentInstance.customAccessor.writeValue
      ).toHaveBeenCalled();
    }));
  });
  ...
  describe("with a falsy value", () => {
    beforeEach(waitForAsync(() =>
      configureMatSelectTestingModule([FalsyValueSelect])));
    ...
    it("should be able to programmatically select a falsy option", fakeAsync(() => {
      ...
      expect(fixture.componentInstance.options.first.selected)
        ...
        .toBe(true);
      expect(
        overlayContainerElement.querySelectorAll("mat-option")[0].classList
      )
        .withContext("Expected first option to be selected")
        .toContain("mat-selected");
    }));
  ...
  describe("with custom trigger", () => {
    beforeEach(waitForAsync(() =>
      configureMatSelectTestingModule([SelectWithCustomTrigger])));
  ...
  describe("when reseting the value by setting null or undefined", () => {
    beforeEach(waitForAsync(() =>
      configureMatSelectTestingModule([ResetValuesSelect])));
  ...
  describe("without Angular forms", () => {
    ...
    it("should set the value when options are clicked", fakeAsync(() => {
      ...
      (
        overlayContainerElement.querySelectorAll("mat-option")[2] as HTMLElement
      ).click();
      fixture.detectChanges();
      flush();
  ...
  describe("with option centering disabled", () => {
    beforeEach(waitForAsync(() =>
      configureMatSelectTestingModule([SelectWithoutOptionCentering])));
  ...
  describe("positioning", () => {
    ...
    function checkTriggerAlignedWithOption(
      ...
      const triggerFontSize = parseInt(
        window.getComputedStyle(trigger).fontSize || "0"
      );
      const triggerLineHeightEm = 1.125;

      // Extra trigger height beyond the font size caused by the fact that the line-height is
      // greater than 1em.
      const triggerExtraLineSpaceAbove =
        ((1 - triggerLineHeightEm) * triggerFontSize) / 2;
      const topDifference =
    ...
    describe("ample space to open", () => {
      ...
      it("should align a selected option in the middle with the trigger text", fakeAsync(() => {
        ...
        expect(scrollContainer.scrollTop)
          .withContext(
            `Expected overlay panel to be scrolled to center the selected option.`
          )
          .toEqual(88);
      ...
      it("should align a selected option at the scroll max with the trigger text", fakeAsync(() => {
        ...
        expect(scrollContainer.scrollTop)
          .withContext(
            `Expected overlay panel to be scrolled to its maximum position.`
          )
          .toEqual(128);
    ...
    describe("limited space to open vertically", () => {
      ...
      it("should adjust position of centered option if there is little space above", fakeAsync(() => {
        ...
        const idealSpaceAboveSelectedItem =
          (selectMenuHeight - selectItemHeight) / 2;
        ...
        const idealScrollTop =
          actualSpaceAboveSelectedItem - idealSpaceAboveSelectedItem;
        ...
        const formFieldTopSpace =
          ...
          formField.getBoundingClientRect().top;

        const formFieldTop =
          topMostPositionForPerfectCentering -
          formFieldTopSpace -
          expectedExtraScroll;
      ...
      it("should adjust position of centered option if there is little space below", fakeAsync(() => {
        ...
        const formFieldBottomSpace =
          formField.getBoundingClientRect().bottom -
          trigger.getBoundingClientRect().bottom;

        const formFieldBottom =
          bottomMostPositionForPerfectCentering -
          formFieldBottomSpace -
          expectedExtraScroll;
      ...
      it('should fall back to "above" positioning if scroll adjustment will not help', fakeAsync(() => {
        ...
        const difference =
          Math.floor(overlayBottom) - Math.floor(triggerBottom);
    ...
    describe("x-axis positioning in multi select mode", () => {
      ...
      beforeEach(fakeAsync(() => {
        ...
        multiFixture.detectChanges();
        formField = multiFixture.debugElement.query(
          By.css(".mat-form-field")
        )!.nativeElement;
        trigger = multiFixture.debugElement.query(
          By.css(".mat-select-trigger")
    ...
    describe("x-axis positioning with groups", () => {
      ...
      it("should not adjust if all options are within a group, except the selected one", fakeAsync(() => {
        ...
        const selected = document.querySelector(
          ".cdk-overlay-pane mat-option.mat-selected"
        )!;
        const selectedOptionLeft = selected.getBoundingClientRect().left;
        const triggerLeft = trigger.getBoundingClientRect().left;

        // 16px is the default option padding
        expect(Math.floor(selectedOptionLeft)).toEqual(
          Math.floor(triggerLeft - 16)
        );
      }));
  ...
  describe("with multiple selection", () => {
    ...
    it("should select all options when pressing ctrl + a", () => {
      ...
      const event = createKeyboardEvent("keydown", A, undefined, {
        control: true,
      });
    ...
    it("should not throw when selecting a large amount of options", fakeAsync(() => {
      ...
      const lotsOfOptionsFixture = TestBed.createComponent(
        MultiSelectWithLotsOfOptions
      );
    ...
    it("should be able to programmatically set an array with duplicate values", fakeAsync(() => {
      ...
      expect(
        optionNodes.map((node) => node.classList.contains("mat-selected"))
    ...
    it("should update the option selected state if the same array is mutated and passed back in", fakeAsync(() => {
      ...
      expect(
        optionNodes.some((option) => option.classList.contains("mat-selected"))
      ).toBe(false);
...
@Component({
  ...
  template: `<custom-select-accessor
    [formControl]="ctrl"
...
class CompWithCustomSelect {
  ...
  @ViewChild(CustomSelectAccessor, { static: true })
  customAccessor: CustomSelectAccessor;
}
...
@Component({
  ...
  template: `<mat-form-field
    ><mat-select tabindex="5"></mat-select
  ></mat-form-field>`,
})
