...
describe('splitter', () => {
  ...
  describe('basic', () => {
    ...
    it('should render splitter-bar', () => {
      const handles = splitterElement.querySelectorAll('tri-splitter-bar');
    ...
    it('should change splitterbar size', () => {
      ...
      fixture.detectChanges();
      expect(splitterElement.querySelectorAll('tri-splitter-bar')[0].clientWidth).toBe(3);
    });
    ...
    it('should minimum size work', fakeAsync(() => {
      ...
      const spliterBarElement = splitterElement.querySelectorAll('tri-splitter-bar')[0] as HTMLElement;
      // 模拟鼠标事件
