...
export class TagInputComponentTagsAsObjects {
  public items = [
    { value: 0, display: "React" },
    { value: 1, display: "Angular" },
  ];
}
...
@Component({
  selector: "test-app",
  template: `<tag-input [(ngModel)]="items" [validators]="validators">
  </tag-input>`,
})
...
@Component({
  selector: "test-app",
  template: `<tag-input [(ngModel)]="items" [onAdding]="onAdding">
  </tag-input>`,
})
...
@Component({
  ...
  template: `<tag-input [(ngModel)]="items">
    <ng-template let-item="item">
      <span class="custom-class"> item: {{ item }} </span>
...
@Component({
  selector: "test-app",
  template: `<tag-input [(ngModel)]="items" [onlyFromAutocomplete]="true">
    <tag-input-dropdown
      [autocompleteItems]="['item1', 'item2', 'itam3']"
    ></tag-input-dropdown>
  </tag-input>`,
...
@Component({
  selector: "test-app",
  template: `<tag-input [(ngModel)]="items" [editable]="true"></tag-input>`,
})
